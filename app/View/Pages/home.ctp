...
<div class="page-header">
	...
	<p>
		<a class="btn btn-primary" href="http://cakephp.org/changelogs/<?php echo Configure::version(); ?>"><?php echo __d('cake_dev', 'Read the changelog'); ?> </a>
	</p>
</div>
<?php
...
?>
<p id="url-rewriting-warning" class="alert">
	<?php echo __d('cake_dev', 'URL rewriting is not properly configured on your server.'); ?><br />
	1) <a target="_blank" href="http://book.cakephp.org/2.0/en/installation/url-rewriting.html">Help me configure it</a><br />
	2) <a target="_blank" href="http://book.cakephp.org/2.0/en/development/configuration.html#cakephp-core-configuration">I don't / can't use URL rewriting</a><br />
</p>
<p>
<?php
	if (version_compare(PHP_VERSION, '5.2.8', '>=')):
		echo '<span class="alert alert-success span12">';
			echo __d('cake_dev', 'Your version of PHP is 5.2.8 or higher.');
		echo '</span>';
	else:
		echo '<span class="alert alert-error span12">';
...
<p>
	<?php
		...
		if (!empty($settings)):
			echo '<span class="alert alert-info span12">';
...
<?php
	...
	if (!Validation::alphaNumeric('cakephp')) {
		echo '<p><span class="alert alert-error span12">';
...
<p>
<?php
echo __d('cake_dev', 'To change the content of this page, edit: <b>APP/View/Pages/home.ctp</b>.<br />
To change its layout, edit: <b>APP/View/Layouts/default.ctp</b>.<br />
You can also add some CSS styles for your pages at: <b>APP/webroot/css</b>.');
?>
</p>
