 ...
 */
	protected $_templates = array(
		...
		'html' => array(
			'trace' => '<pre class="cake-error alert alert-error trace"><b>Trace</b> <p>{:trace}</p></pre>',
			'context' => '<pre class="cake-error alert alert-error context"><b>Context</b> <p>{:context}</p></pre>',
			'escapeContext' => true,
		),
		'txt' => array(
 ...
 */
	public function __construct() {
		...
		$e = '<pre class="cake-error alert alert-error">';
		...
		$e = '<pre class="cake-error alert alert-error"><b>{:error}</b> ({:code}) : {:description} ';
